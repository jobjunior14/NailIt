        ...
        <ScrollView nestedScrollEnabled className="w-full h-full flex-col">
          ...
          <View className={` pb-6 mt-3`}>
            <Text className=" font-interRegular  text-white leading-5">
              ...
              necessitatibus suscipit consequuntur optio! Lorem ipsum dolor, sit
              amet consectetur adipisicing elit. Officia delectus sint nam
              ...
              porro quidem magni autem, debitis tempora error assumenda aperiam
              eligendi aliquam nam adipisci unde, qui corporis alias enim
              voluptatem. Lorem ipsum dolor sit amet consectetur, adipisicing
              elit. Vitae mollitia inventore exercitationem labore voluptatibus,
              distinctio, velit tenetur consequuntur quasi quia ex eveniet
              minus? Veniam tempore quasi ipsa suscipit aut explicabo!
            </Text>
          </View>
        </ScrollView>
      </View>
